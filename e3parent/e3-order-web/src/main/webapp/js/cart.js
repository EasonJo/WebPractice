...
$(document).ready(function () {
    $(".cartAddrPrice").slideDown(300, function () {
        setTimeout(function () {
            $(".cartAddrPrice").slideUp(300)
        }, 4000)
    });
})
...
function favC(id) {
    $.post(cartHostUrl + "/favorites/create/product_id/" + id + "/", {ispresale: 0}, function (str) {
        ...
        if (str.status == 2) {
            ...
            $("#getfavok" + id).slideDown(300, function () {
                setTimeout(function () {
                    $("#getfavok" + id).slideUp(300)
                }, 2000)
            });
            //	jAlert('该商品收藏成功');
        } else {
...
function favNM(id) {
    $.post(cartHostUrl + "/favorites/create/product_id/" + id + "/", {ispresale: 0}, function (str) {
        ...
        if (str.status == 2) {
            ...
            $("#getfavoknm" + id).slideDown(300, function () {
                setTimeout(function () {
                    $("#getfavoknm" + id).slideUp(300)
                }, 2000)
            });
            //	jAlert('该商品收藏成功');
        } else {
...
function favC_sfv(id) {
    $.post(cartHostUrl + "/favorites/create/product_id/" + id + "/", {is_sfv: 1}, function (str) {
        ...
        if (str.status == 2) {
            ...
            $("#getsfvfavok" + id).slideDown(300, function () {
                setTimeout(function () {
                    $("#getsfvfavok" + id).slideUp(300)
                }, 2000)
            });
            //	jAlert('该商品收藏成功');
        } else {
