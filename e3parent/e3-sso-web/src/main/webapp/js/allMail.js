...
var defaultArr = [], OkArr = [], memArr = [], pwdArr = [], pwd2Arr = [], mcodeArr = [], codeArr = [], dmArr = [],
    agreeArr = [];
OkArr[0] = '通过信息验证！';
memArr[0] = '请输入您的手机号码';
memArr[1] = '请输入正确的手机号码';
...
var comArr = [], cpyDefaultArr = [], cpyUserNameArr = [], cpyPwdArr = [], cpyPwd2Arr = [], cpyCodeArr = [],
    cpyRealNameArr = [], cpyTelArr = [], cpyMobArr = [], cpyMaArr = [], cpyNameArr = [], cpyAddressArr = [],
    cpyBuyuseArr = [], cpyWebsiteArr = [], cpyAgreeArr = [];
