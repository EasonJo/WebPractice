        ...
        return $(this).each(function () {
            $(this).hover(function () {
                ...
                h = setTimeout(function () {
                    s.hoverEvent.apply(that)
                }, s.hoverDuring);
            }, function () {
                clearTimeout(h);
                o = setTimeout(function () {
                    s.outEvent.apply(that)
                }, s.outDuring);
            });
        });
    };
...
function timeFun() {
    ...
    //右侧广告位关闭
    if ($(".index_rfloat").length) {
        $(".J_rclose").click(function () {
            $(".index_rfloat").hide();
        });
    }
}
 ...
 ***/
$(document).ready(function () {
    $("#store-selector1").mouseover(function () {
        $(this).addClass("hover");
    });
    $("#store-selector1").hover(function () {
        $("#store-selector1").removeClass("hover");
    });
...
$(function () {
    ...
    if (index_win_w <= 1440) {
        $(".index_rfloat").addClass("index_side");
    }
    else {
        $(".index_rfloat").removeClass("index_side");
    }
    $(window).resize(function () {
        var index_win_width = $(window).width();
        if (index_win_width <= 1440) {
            $(".index_rfloat").addClass("index_side");
        }
        else {
            $(".index_rfloat").removeClass("index_side");
