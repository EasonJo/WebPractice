...
(function () {
    ...
    Goods.arrivalNoticeDo = function () {
        ...
        $.post("/Goods/ArrivalNoticeDo/product_id/" + _SF_CFG.productId + "/", {
            flag: flag,
...
function poptipShow() {
    $(".has_poptip").hover(function () {
        var top = $(".points").offset().top + 85, left = $(".points").offset().left + 20, a_left = 26,
            i = $(this).index();
        if (0 == i) {
            a_left = 145
        } else if (1 == i) {
        ...
        $(".ui-poptip").css({"top": top, "left": left});
        $(".ui-poptip-arrow-11").css("right", a_left);
    }, function () {
        $(".ui-poptip").remove();
    });
}
